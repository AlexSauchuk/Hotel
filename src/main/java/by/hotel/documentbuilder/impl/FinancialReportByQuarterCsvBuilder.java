...
public class FinancialReportByQuarterExcelBuilder extends ExcelDocumentBuilder<Report>{
    private static final int QUARTER_COUNT = 4;

    public FinancialReportByQuarterExcelBuilder() {
        super("Financial report by quarter.xls");
    }

    private static class Holder{
        private final static FinancialReportByQuarterExcelBuilder INSTANCE = new FinancialReportByQuarterExcelBuilder();
    }

    public static FinancialReportByQuarterExcelBuilder getInstance(){
        return FinancialReportByQuarterExcelBuilder.Holder.INSTANCE;
    }

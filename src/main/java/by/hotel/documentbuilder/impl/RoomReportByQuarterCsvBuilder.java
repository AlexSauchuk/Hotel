...
public class RoomReportByQuarterExcelBuilder extends ExcelDocumentBuilder<Report>{
    private static final int QUARTER_COUNT = 4;
    private static final int HEADER_ROWS_COUNT = 2;

    public RoomReportByQuarterExcelBuilder(){
        super("Room report by quarter.xls");
    }

    private static class Holder{
        private final static RoomReportByQuarterExcelBuilder INSTANCE = new RoomReportByQuarterExcelBuilder();
    }

    public static RoomReportByQuarterExcelBuilder getInstance(){
        return RoomReportByQuarterExcelBuilder.Holder.INSTANCE;
    }

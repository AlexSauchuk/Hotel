...
public class RoomReportByMonthExcelBuilder extends ExcelDocumentBuilder<Report> {
    private static final int HEADER_ROWS_COUNT = 2;

    public RoomReportByMonthExcelBuilder() {
        super("Room report by month.xls");
    }

    private static class Holder{
        private final static RoomReportByMonthExcelBuilder INSTANCE = new RoomReportByMonthExcelBuilder();
    }

    public static RoomReportByMonthExcelBuilder getInstance(){
        return RoomReportByMonthExcelBuilder.Holder.INSTANCE;
    }

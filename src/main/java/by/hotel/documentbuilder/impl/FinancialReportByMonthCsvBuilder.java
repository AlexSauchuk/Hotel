...
public class FinancialReportByMonthExcelBuilder extends ExcelDocumentBuilder<Report>{
    public FinancialReportByMonthExcelBuilder() {
        super("Financial report by month.xls");
    }

    private static class Holder{
        private final static FinancialReportByMonthExcelBuilder INSTANCE = new FinancialReportByMonthExcelBuilder();
    }

    public static FinancialReportByMonthExcelBuilder getInstance(){
        return FinancialReportByMonthExcelBuilder.Holder.INSTANCE;
    }
